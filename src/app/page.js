    ...
    <div className="flex flex-col items-center justify-center gap-y-10">
      ...
      <div className="flex flex-col gap-5 w-1/2 items-center">
        <p>
          ...
          in engineering and technology. Based at UTRGV Edinburg Campus, Engineering Building (EENGR 2.296), our branch operates under the global umbrella of the Institute of Electrical and Electronics Engineers (IEEE), the world's largest technical professional organization.
        </p>
